        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="border border-green-500/40 bg-green-500/5 p-4 space-y-3">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center gap-2">
                <WalletIcon />
                <span className="text-green-200">50 active wallets</span>
              </div>
              <div className="flex items-center gap-2">
                <CrownIcon />
          ...
          <h2 className="text-lg font-bold text-green-300 text-center">How It Works</h2>
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              <div className="space-y-2">
                <h3 className="font-semibold text-green-200">For You</h3>
                <p className="text-green-300/80">
                  Share your referral link and earn 25% commission from referral Pro upgrades. Future revenue sharing from trading fees.
                </p>
              </div>
              <div className="space-y-2">
                <h3 className="font-semibold text-green-200">For Your Friends</h3>
                <p className="text-green-300/80">
                  They get 25% off their Pro upgrade when using your link.
                </p>
              </div>
            </div>
        </div>
