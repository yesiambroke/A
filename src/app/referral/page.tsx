...
import ReferralAdvertising from "@/components/referral/ReferralAdvertising";
import ReferralMarketing from "@/components/referral/ReferralMarketing";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "A-TRADE://referral",
};
  ...
  return (
    <div className="min-h-screen bg-black px-1 py-1 sm:px-3 sm:py-2 font-mono text-green-400">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[98vw] sm:max-w-[97vw]">
        <div className="border-2 border-green-500 bg-black shadow-2xl shadow-green-500/20 h-[calc(100vh-1rem)] overflow-y-auto">
          {session ? (
            <ReferralAdvertising user={session} operator={operator} />
          ) : (
            <ReferralMarketing />
          )}
        </div>
